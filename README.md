...
Local-only directories (repo analysis clones, tooling venvs) live under `.cursor/workspaces/` and are not committed—configure secrets via a local `.env` file (gitignored).
